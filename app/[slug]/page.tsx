...
const pages: Record<string, PageData> = {
  services: {
    ...
    sections:[
      ...
      {title:"Planning Transformation",copy:"Future-state process and solution design across merchandising, demand, inventory and supply planning.",items:["Process redesign","Decision rights and planner roles","Planning calendar","Data and hierarchy design","Solution architecture"]},
  ...
  capabilities:{eyebrow:"CAPABILITIES",title:"Planning expertise across the retail decision lifecycle.",description:"Averin connects financial planning, assortment, demand, inventory and supply so teams understand both the local decision and its downstream impact.",sections:[
  ...
  "technology-advisory":{eyebrow:"PLANNING TECHNOLOGY ADVISORY",title:"Select planning technology with confidence.",description:"A planning platform can shape processes for years. Averin provides independent support from requirements through recommendation, with business scenarios at the centre of the evaluation.",sections:[
    {title:"Don’t compare features. Compare decisions.",copy:"Averin defines common business scenarios so platforms are evaluated against the same decisions, workflows, constraints, data needs and financial outcomes."},
    {title:"Selection Method",items:["Business strategy","Current-state assessment","Capability requirements","Functional, data and AI requirements","Vendor longlist","RFI / RFP","Scripted demonstrations","Scoring and TCO","Architecture assessment","Recommendation and roadmap"]},
  ...
  "ai-retail-planning":{eyebrow:"AI FOR RETAIL PLANNING",title:"Retail expertise first. AI second.",description:"Averin helps planning organizations identify where AI can improve decisions—and where better process, data or decision design should come first.",sections:[
    {title:"Planning Intelligence",copy:"Detect anomalies, risks, conflicts and emerging planning conditions earlier."},
    ...
    {title:"AI Readiness",items:["Define the planning decision","Identify required measures, hierarchies and attributes","Document what holds and what flexes","Encode constraints and policies","Define AI recommendation vs human approval boundaries","Measure financial and operational impact"]}
  ]},
  "health-check":{eyebrow:"RETAIL PLANNING HEALTH CHECK™",title:"Find out where planning is getting stuck—and what to do next.",description:"A focused independent diagnostic designed to create executive-level clarity on planning maturity, capability gaps and transformation priorities.",sections:[
    {title:"What We Assess",items:["Strategy and outcomes","Process and decisions","People and governance","Data and KPIs","Technology and architecture","Analytics and AI readiness"]},
    {title:"Maturity Model",items:["Level 1 — Reactive: manual and spreadsheet-heavy","Level 2 — Standardized: defined processes and measures","Level 3 — Integrated: connected functions and shared data","Level 4 — Predictive: forecasting, optimization and exceptions","Level 5 — Intelligent: AI-assisted, scenario-driven orchestration"]},
  ...
  about:{eyebrow:"ABOUT AVERIN",title:"Practitioner-led retail planning advisory.",description:"Averin Consulting was created to give retailers and manufacturers independent, experienced guidance across planning strategy, process transformation, technology and AI.",sections:[
    ...
    {title:"Our Principles",items:["Design the decision before the workflow","Fix the operating model before automating it","Make vendors prove business outcomes","Use AI where judgment can be augmented responsibly"]}
  ]},
  insights:{eyebrow:"AVERIN INSIGHTS",title:"Practical thinking for retail planning leaders.",description:"Perspectives on planning decisions, operating models, software evaluation, architecture and AI—written for practitioners rather than for buzzword cycles.",sections:[
    ...
    {title:"Why Retail Planning Needs Decision Architecture Before AI",copy:"AI recommendations are only as good as the decisions, policies, dependencies and metrics they are built around."},
  ...
  contact:{eyebrow:"CONTACT",title:"Start with the planning problem—not a sales pitch.",description:"Tell us where planning, technology or transformation is getting stuck. We can begin with a focused conversation and determine whether an advisory engagement would be useful.",sections:[
    {title:"Good reasons to reach out",items:["You need an independent planning maturity assessment","You are preparing to select or replace a planning platform","Your MFP, assortment, allocation or replenishment processes need redesign","You need a client-side design authority during implementation","You are defining an AI roadmap for retail planning"]}
  ]}
};
