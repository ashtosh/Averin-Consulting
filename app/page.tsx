...
const services = [
  ...
  ["Planning Transformation", "Connect merchandise, demand, inventory and supply planning into a closed-loop decision system that continuously learns and reshapes the next plan."],
...
export default function Home() {
  return <>
    ...
    <section className="achievement-band"><div className="container achievement-grid">
      ...
      <div><strong>Closed-loop</strong><span>Plan through execution, learning and continuous reshaping of the next decision cycle</span></div>
    </div></section>
